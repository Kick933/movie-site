  ...
  return (
    <div className='my-28 mx-auto'>
        <form className='flex flex-col justify-center gap-8 items-center'>
          ...
          <input type='text' onChange={handleChange} name='search' id='search' className='w-3/4 dark:bg-gray-900 text-center sm:w-96 mx-auto focus-visible:outline-none focus:border-sky-400 active:border-sky-400 border-sky-800 text-xl text-sky-600 h-16 p-2 block border-2 rounded-xl' placeholder='Enter Movie name' />
