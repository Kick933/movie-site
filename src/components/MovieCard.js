...
function MovieCard(props) {
    ...
    if (config.images) {
        ...
        return (
                <div className='rounded-xl grow-0 first:ml-12 last:mr-12 shrink-0 relative contrast-125 group my-10 h-auto md:h-80 bg-white border flex flex-col w-36 md:w-48 text-gray-100 shadow-lg'>
