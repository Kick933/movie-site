...
function MovieCard(props) {
    ...
    if (config.images) {
        ...
        return (
            <>
                <div>
                    <div className="bg-gray-600 flex-shrink-0 w-32 md:w-48 text-gray-100 rounded-xl m-1 md:mx-2 overflow-hidden transform hover:-translate-y-4 transition shadow-lg">
