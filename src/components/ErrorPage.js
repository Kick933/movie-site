...
function ErrorPage(props) {
    ...
    if(wrongPath === true){
        ...
        <Link to="/"><button className='w-28 text-lg text-black rounded-lg h-8 bg-green-400 hover:bg-green-500'>Go to Home</button></Link>
    </div>
        )
    }else{
        return (
        ...
        <Link to="/"><button className='w-28 text-lg text-black rounded-lg h-8 bg-violet-500 hover:bg-violet-400'>Go to Home</button></Link>
    </div>
        )
    }
