...
export default function Menu() {
  ...
  return (
    <nav className='w-full flex justify-center top-20 left-0 right-0 min-h-screen absolute bg-white z-30 text-center text-2xl text-sky-600 flex-grow-0 flex-shrink-0'>
      <ul className='w-full flex flex-col justify-center items-center gap-4'>
        ...
        <>
          ...
          <li className='w-80 h-20'><Link className='hover:text-sky-300 w-full p-2 block hover:scale-110 hover:border-b-4 rounded-md border-sky-300 border-b transition-all' to= '/favorite'>Favorites</Link></li>
          <li className='w-80 h-20'><Link className='hover:text-sky-300 w-full p-2 block hover:scale-110 hover:border-b-4 rounded-md border-sky-300 border-b transition-all' to= '/watchlist'>My Watchlist</Link></li>  
